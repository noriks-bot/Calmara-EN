...
WordPress theme + site code for **Calmara** brand, market **SI**.

- **Subdomain:** `si_calmara.noriks.com` → `18.197.40.171` (brand-machine)
- **Theme:** `calmara/` (forked from Noriks WP theme, Storefront-based)
- **Source:** copied from `wp-noriks-si{-pravi?}` on 2026-06-09
